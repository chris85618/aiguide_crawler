...
public class CrawlerTest {
    ...
    public void testGiveTwoDirectiveAndWillGetNineLearningTask() {
        ...
        List<Action> actionSet = new LinkedList<>();
        actionSet.add(action);
        List<HighLevelAction> highLevelAction = createLoginPageHighLevelActions();

        Map<String, List<HighLevelAction>> directives = new HashMap<>();
        directives.put(firstStateID, highLevelAction);
        // second iteration
        ...
        directive_2.put(firstStateID, highLevelAction);
