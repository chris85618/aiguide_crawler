...
public class CrawlerTest {
    ...
    public void testWillGetOneLearningTask() {
        ...
        config.setCrawlingRootUrl("http://localhost:3000/calendar/");
        config.setDepth(20);
    ...
    @Test
    public void testGiveTwoDirectiveAndWillGetTwoLearningTask() {
        Config config = new Config();
        config.setCrawlingRootUrl("http://localhost:3000/");
        config.setDepth(5);
